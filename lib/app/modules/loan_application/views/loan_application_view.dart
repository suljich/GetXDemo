              ...
              Column(
                ...
                children: [
                  ...
                  CustomTextfieldView(
                    ...
                    title: 'monthly_salary'.tr,
                    hintText: 'enter_your_salary'.tr,
                  ),
                  CustomTextfieldView(
                    textController: controller.expensesController,
                    title: 'monthly_expenses'.tr,
                    hintText: 'enter_your_monthly_expenses'.tr,
                  ),
                  Padding(
                    padding: const EdgeInsets.fromLTRB(
                      16,
                  ...
                  CustomTextfieldView(
                    ...
                    title: 'amount'.tr,
                    hintText: 'enter_the_loan_amount'.tr,
                  ),
                  CustomTextfieldView(
                    textController: controller.termController,
                    title: 'term'.tr,
                    hintText: 'enter_the_term'.tr,
                    isTerm: true,
                  ),
                  Expanded(
                    child: Center(
